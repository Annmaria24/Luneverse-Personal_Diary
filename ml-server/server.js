...
app.post('/predict', (req, res) => {
    ...
    try {
        ...
        // Filter out 'Neutral' from classifications as per requirement (Neutral only for empty tokens)
        const validClassifications = classifications.filter(c => c.label !== "Neutral");

        // The classifier already sorts them by probability (highest first).
        ...
        // Calculate confidence securely using Softmax to handle negative log probabilities properly
        let confidence = 0.5;
