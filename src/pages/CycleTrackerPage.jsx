...
import { getPregnancyData, getPregnancyStats, deletePregnancyEntry } from "../services/pregnancyService";
...
// Removed consumption tracking state as per user request
  ...
  const periodInfo = useMemo(() => ({ intervals: [], startSet: new Set(), endSet: new Set() }), []);
  ...
  const renderCalendar = () => {
    ...
    for (let day = 1; day <= daysInMonth; day++) {
      ...
      let dataClass = '';
      // Compute dateObj for this calendar day
